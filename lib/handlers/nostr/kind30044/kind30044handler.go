...
// BuildKind30044Handler creates a handler for DHT Relay List events (kind 30044)
// These events contain relay lists that should be stored in the DHT
func BuildKind30044Handler(store stores.Store) func(read lib_nostr.KindReader, write lib_nostr.KindWriter) {
