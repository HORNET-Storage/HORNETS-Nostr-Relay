...
func (store *GravitonMemoryStore) RetrieveLeaf(root string, hash string, includeContent bool) (*merkle_dag.DagLeaf, error) {
...
func (store *GravitonMemoryStore) BuildDagFromStore(root string, includeContent bool) (*merkle_dag.Dag, error) {
